...
class PCA9685:
    ...
    def __init__(self, channel, address=0x40, frequency=60, busnum=None, init_delay=0.1):
        ...
        import donkeycar.parts.Loongnix_PCA9685 as Loongnix_PCA9685
        # Initialise the PCA9685 using the default address (0x40).
        if busnum is not None:
            from donkeycar.parts.Loongnix_PCA9685 import I2C
        ...
        self.pwm = Loongnix_PCA9685.PCA9685(address=address)
...
class L298N_HBridge_3pin(object):
    ...
    def __init__(self, pin_forward: OutputPin, pin_backward: OutputPin, pwm_pin: PwmPin, zero_throttle: float = 0,
                 max_duty=0.9):
        """
